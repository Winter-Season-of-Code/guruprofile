...
<?php
$name_err=$pwd_err=$cpwd_err=$no_err=$email_err=$addr_err="";
$success="";
if($_SERVER['REQUEST_METHOD']=="POST"){
		...
		if(empty($name_err) && empty($pwd_err) && empty($email_err) && empty($no_err)){
			if($obj->user_existance("admin",$email)){
				if($obj->bind_insert("admin",array("",$name,$email,$pwd,$phno,$addr))){
         ...
         <div class="form-body">
              ...
              <div class="row">
                   ...
                   <div class="form-group">
                        ...
                        <input name="addr" type="text" class="form-control" required placeholder="Address">
                        </div>  
